...
<nav class="navbar navbar-inverse sidebar" role="navigation">
    <div class="container-fluid">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="#">SoundCar</a>
		</div>
			...
			<ul class="nav navbar-nav">
                ...
                <li class="dropdown">
					...
					<ul class="dropdown-menu forAnimate" role="menu">
						...
						<li>
                                            <?php echo $this->Html->link("Lista de Carros", array('controller'=>'carros', 'action'=>'index'));?> </li>
						
					</ul>
				</li>
                
                <li class="dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown">Empleados <span class="caret"></span><span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-book"></span></a>
					<ul class="dropdown-menu forAnimate" role="menu">
						<li>
                        ...
                        <li> <span class="glyphicon glyphicon-list"></span>
                                            <?php echo $this->Html->link("Lista de Instalaciones", array('controller'=>'instalacions', 'action'=>'index'));?></li>
                        <li> <span class="glyphicon glyphicon-list"></span>
                                            <?php echo $this->Html->link("Panel de Instalaciones", array('controller'=>'instalacions', 'action'=>'panelconsulta'));?></li>
                        <li>
